...
from VGG_face_TF import VGG_FACE_16_layer
...
MODELS = (AlexNet, CaffeNet, GoogleNet, NiN, ResNet50, ResNet101, ResNet152, VGG16, VGG_FACE_16_layer)
...
MODEL_DATA_SPECS = {
	...
	VGG_FACE_16_layer: std_spec(batch_size=1)
}
