import os
import random
DATA_DIR='/home/djecklocal/Documents/python/FaceGender/Data/aligned'
original_folds_dir='/home/djecklocal/Documents/python/FaceGender/Data/Folds/original_txt_files'
out_files_dir='/home/djecklocal/Documents/python/FaceGender/Data/Folds/train_val_txt_files_per_fold2'
...
for cur_test_fold_ind in range(5):
    ...
    #test files
    cur_test_fold_filename='fold_frontal_{0}_data.txt'.format(cur_test_fold_ind)
